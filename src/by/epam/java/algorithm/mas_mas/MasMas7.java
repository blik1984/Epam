 ...
 * сформировать квадратную матрицу по правилу A[I,J]=sin((I^2-J^2)N). Порядок матрицы задан пользователем.
 */
...
public class MasMas7 {
	...
	public static void main(String[] args) {
		...
		System.out.println("Введите порядок матрицы в виде положительного числа"); 
		n = S.nextInt();
